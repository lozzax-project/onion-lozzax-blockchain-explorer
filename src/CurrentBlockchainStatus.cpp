...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = lozzeg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.bitlozzax/lmdb"};
...
string CurrentBlockchainStatus::deamon_url {"http:://127.0.0.1:11112"};
...
lozzeg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
